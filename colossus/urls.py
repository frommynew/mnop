...
urlpatterns = [
    ...
    path(
        "notifications/",
        include("colossus.apps.notifications.urls", namespace="notifications"),
    ),
    ...
    path(
        ...
        core_views.subscribe_shortcut,
        name="subscribe_shortcut",
    ),
    path(
        "<slug:mailing_list_slug>/unsubscribe/",
        core_views.unsubscribe_shortcut,
        name="unsubscribe_shortcut",
    ),
]
