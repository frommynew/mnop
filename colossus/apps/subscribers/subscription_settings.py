...
SUBSCRIPTION_FORM_TEMPLATE_SETTINGS = {
    ...
    TemplateKeys.SUBSCRIBE_FORM: {
        ...
        "description": _(
            "Entry point for the subscription workflow. Displays the subscription form."
        ),
    ...
    TemplateKeys.SUBSCRIBE_THANK_YOU_PAGE: {
        ...
        "icon": "fas fa-globe",
        "description": _(
            "Page shown right after a successful form submission. "
    ...
    TemplateKeys.CONFIRM_EMAIL: {
        ...
        "description": _(
            "Email message sent to the subscriber with a link to confirm the subscription process."
        ),
    ...
    TemplateKeys.CONFIRM_THANK_YOU_PAGE: {
        ...
        "icon": "fas fa-globe",
        "description": _(
            "Web page shown after clicking and confirming the subscription. "
    ...
    TemplateKeys.GOODBYE_EMAIL: {
        ...
        "icon": "far fa-envelope",
        "description": _(
            "Optional goodbye email to let the subscriber know they were successfully "
